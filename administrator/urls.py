...
urlpatterns = [
    ...
    path('users/students/import/', views.import_students, name='import_students'),
    path('users/students/import/template/', views.download_student_import_template, name='student_import_template'),
    path('users/teachers/', views.teachers_list, name='teachers_list'),
    path('users/teachers/import/', views.import_teachers, name='import_teachers'),
    path('users/teachers/import/template/', views.download_teacher_import_template, name='teacher_import_template'),
